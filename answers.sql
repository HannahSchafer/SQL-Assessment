...
SELECT models.name, brands.name, brands.headquarters from BRANDS 
JOIN models ON models.brand_id = brands.brand_id
...
HAVING COUNT(models.brand_id ) > 5;
...
SELECT models.name, models.year FROM models WHERE models.year IN
